...
namespace Nami.Tests.Services
{
    [TestFixture]
    public sealed class DbAbstractionService2Tests : INamiServiceTest<ConcreteService2>
    {
        ...
        private void AddMockData(NamiDbContext db)
        {
    ...
    [TestFixture]
    public sealed class DbAbstractionService3Tests : INamiServiceTest<ConcreteService3>
    {
        ...
        private IEnumerable<ulong> GetGuildRoles(NamiDbContext db, ulong gid)
    ...
    public class ConcreteService3 : DbAbstractionServiceBase<AutoRole, ulong, ulong>
    {
        ...
        public override DbSet<AutoRole> DbSetSelector(NamiDbContext db) => db.AutoRoles;
