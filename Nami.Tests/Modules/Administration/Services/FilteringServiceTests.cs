...
{
    public sealed class FilteringServiceTests : INamiServiceTest<FilteringService>
    {
        ...
        public async Task RemoveFiltersAsyncTests()
        {
            ...
            void AssertFiltersRemoved(NamiDbContext db, ulong gid, params int[]? ids)
            {
                if (ids?.Any() ?? false) {
            ...
            void AssertFilterRegexesRemoved(NamiDbContext db, ulong gid, params string[]? regexStrings)
            {
        ...
        private void AddMockFilters(NamiDbContext db)
        {
        ...
        private void AssertGuildFilterCount(NamiDbContext db, int index, int count)
        {
        ...
        private void UpdateFilterCount(NamiDbContext db)
        {
