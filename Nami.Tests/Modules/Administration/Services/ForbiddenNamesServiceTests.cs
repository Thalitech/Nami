...
namespace Nami.Tests.Modules.Administration.Services
{
    public sealed class ForbiddenNamesServiceTests : INamiServiceTest<ForbiddenNamesService>
    {
        ...
        public async Task RemoveForbiddenNamesAsyncTests()
        {
            ...
            void AssertForbiddenNamesRemoved(NamiDbContext db, ulong gid, params int[]? ids)
            {
                if (ids?.Any() ?? false) {
            ...
            void AssertForbiddenNameRegexesRemoved(NamiDbContext db, ulong gid, params string[]? regexStrings)
            {
        ...
        private void AddMockForbiddenNames(NamiDbContext db)
        {
        ...
        private void AssertGuildForbiddenNameCount(NamiDbContext db, int index, int count)
        {
        ...
        private void AssertSingleAndTest(NamiDbContext db, int index, string regex, bool match, params string[] tests)
        {
        ...
        private void UpdateForbiddenNameCount(NamiDbContext db)
        {
