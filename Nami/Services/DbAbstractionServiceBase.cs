...
{
    public abstract class DbAbstractionServiceBase<TEntity, TEntityId> : INamiService
        where TEntity : class, IEquatable<TEntity>
    {
        ...
        public abstract DbSet<TEntity> DbSetSelector(NamiDbContext db);
    ...
    public abstract class DbAbstractionServiceBase<TEntity, TGroupId, TEntityId> : INamiService
        where TEntity : class, IEquatable<TEntity>
    {
        protected readonly DbContextBuilder dbb;
