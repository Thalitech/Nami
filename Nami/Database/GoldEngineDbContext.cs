...
{
    public class NamiDbContext : DbContext
    {
        #region db sets
        ...
        public virtual DbSet<Stream> Streams { get; protected set; }
        #endregion
...
#pragma warning disable CS8618 // Non-nullable field is uninitialized. Consider declaring as nullable.
        public NamiDbContext(DbProvider provider, string connectionString)
        {
            this.Provider = provider;
            this.ConnectionString = connectionString;
        }

        public NamiDbContext(DbProvider provider, string connectionString, DbContextOptions<NamiDbContext> options)
            : base(options)
        {
            this.Provider = provider;
            this.ConnectionString = connectionString;
...
#pragma warning restore CS8618 // Non-nullable field is uninitialized. Consider declaring as nullable.
        ...
        protected override void OnModelCreating(ModelBuilder mb)
        {
            ...
            mb.Entity<GuildConfig>().Property(gcfg => gcfg.StreamerBadge).HasDefaultValue(null);
            ...
            mb.Entity<Stream>().HasKey(sr => new { sr.GuildIdDb, sr.MemberID, sr.Joined });
        }
    }
}
