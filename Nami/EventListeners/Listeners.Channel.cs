...
namespace Nami.EventListeners
{
    internal static partial class Listeners
    {
        ...
        public static Task DmChannelDeleteEventHandlerAsync(NamiBot bot, DmChannelDeleteEventArgs e)
        {
            LogExt.Debug(
                bot.GetId(null),
        ...
        public static async Task ChannelCreateEventHandlerAsync(NamiBot bot, ChannelCreateEventArgs e)
        {
        ...
        [AsyncEventListener(DiscordEventType.ChannelCreated)]
        public static Task ChannelCreateBackupEventHandlerAsync(NamiBot bot, ChannelCreateEventArgs e)
        {
        ...
        public static async Task ChannelDeleteEventHandlerAsync(NamiBot bot, ChannelDeleteEventArgs e)
        {
        ...
        [AsyncEventListener(DiscordEventType.ChannelDeleted)]
        public static Task ChannelDeleteBackupEventHandlerAsync(NamiBot bot, ChannelCreateEventArgs e)
        {
        ...
        public static async Task ChannelPinsUpdateEventHandlerAsync(NamiBot bot, ChannelPinsUpdateEventArgs e)
        {
        ...
        public static async Task ChannelUpdateEventHandlerAsync(NamiBot bot, ChannelUpdateEventArgs e)
        {
        ...
        public static async Task WebhooksUpdateEventHandlerAsync(NamiBot bot, WebhooksUpdateEventArgs e)
        {
