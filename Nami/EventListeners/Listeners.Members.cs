...
namespace Nami.EventListeners
{
    internal static partial class Listeners
    {
        ...
        public static async Task GuildMemberJoinEventHandlerAsync(NamiBot bot, GuildMemberAddEventArgs e)
        {
            if (e.Guild is null)
                return;
        ...
        [AsyncEventListener(DiscordEventType.GuildMemberAdded)]
        public static async Task GuildMemberJoinProtectionEventHandlerAsync(NamiBot shard, GuildMemberAddEventArgs e)
        {
        ...
        public static async Task GuildMemberRemoveEventHandlerAsync(NamiBot bot, GuildMemberRemoveEventArgs e)
        {
            if (e.Guild is null || e.Member is null || e.Member.IsBot)
                return;
        ...
        public static async Task GuildMemberUpdateEventHandlerAsync(NamiBot bot, GuildMemberUpdateEventArgs e)
        {
            if (e.Guild is null || e.Member is null || e.Member.IsBot)
                return;
        ...
        public static Task GuildMembersChunkedEventHandlerAsync(NamiBot bot, GuildMembersChunkEventArgs e)
        {
        ...
        public static async Task MemberPresenceUpdateEventHandlerAsync(NamiBot bot, PresenceUpdateEventArgs e)
        {
            if (e.User.IsBot)
                return;
