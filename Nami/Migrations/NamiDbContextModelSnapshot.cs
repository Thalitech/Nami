...
{
    [DbContext(typeof(NamiDbContext))]
    partial class NamiDbContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("nami")
                .UseIdentityByDefaultColumns()
                .HasAnnotation("Relational:MaxIdentifierLength", 63)
                .HasAnnotation("ProductVersion", "5.0.1");

            modelBuilder.Entity("Nami.Database.Models.AutoRole", b =>
                {
            ...
            modelBuilder.Entity("Nami.Database.Models.BankAccount", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.Birthday", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.BlockedChannel", b =>
                {
            ...
            modelBuilder.Entity("Nami.Database.Models.BlockedGuild", b =>
                {
                    b.Property<long>("IdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Nami.Database.Models.BlockedUser", b =>
                {
                    b.Property<long>("IdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Nami.Database.Models.BotStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nami.Database.Models.Chicken", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.ChickenBoughtUpgrade", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Nami.Database.Models.ChickenUpgrade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nami.Database.Models.CommandRule", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.EmojiReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nami.Database.Models.EmojiReactionTrigger", b =>
                {
            ...
            modelBuilder.Entity("Nami.Database.Models.ExemptedBackupEntity", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.ExemptedLoggingEntity", b =>
                {
                    b.Property<long>("IdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("xid");
            ...
            modelBuilder.Entity("Nami.Database.Models.ExemptedMentionEntity", b =>
                {
                    b.Property<long>("IdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("xid");
            ...
            modelBuilder.Entity("Nami.Database.Models.ExemptedRatelimitEntity", b =>
                {
                    b.Property<long>("IdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("xid");
            ...
            modelBuilder.Entity("Nami.Database.Models.ExemptedSpamEntity", b =>
                {
                    b.Property<long>("IdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("xid");
            ...
            modelBuilder.Entity("Nami.Database.Models.Filter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nami.Database.Models.ForbiddenName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nami.Database.Models.GameStats", b =>
                {
                    b.Property<long>("UserIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("uid");
            ...
            modelBuilder.Entity("Nami.Database.Models.GuildConfig", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.GuildTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nami.Database.Models.LevelRole", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.Meme", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.PrivilegedUser", b =>
                {
                    b.Property<long>("UserIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("uid");
            ...
            modelBuilder.Entity("Nami.Database.Models.PurchasableItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nami.Database.Models.PurchasedItem", b =>
                {
            ...
            modelBuilder.Entity("Nami.Database.Models.ReactionRole", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.Reminder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nami.Database.Models.RssFeed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nami.Database.Models.RssSubscription", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Nami.Database.Models.SelfRole", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.StarboardMessage", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.TextReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Nami.Database.Models.TextReactionTrigger", b =>
                {
                    b.Property<int>("ReactionId")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Nami.Database.Models.XpCount", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.XpRank", b =>
                {
                    b.Property<long>("GuildIdDb")
                        .HasColumnType("bigint")
                        .HasColumnName("gid");
            ...
            modelBuilder.Entity("Nami.Database.Models.AutoRole", b =>
                {
                    b.HasOne("Nami.Database.Models.GuildConfig", "GuildConfig")
                        .WithMany("AutoRoles")
            ...
            modelBuilder.Entity("Nami.Database.Models.ChickenBoughtUpgrade", b =>
                {
                    b.HasOne("Nami.Database.Models.GuildConfig", null)
                        .WithMany("ChickenBoughtUpgrades")
                        .HasForeignKey("GuildIdDb")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Nami.Database.Models.ChickenUpgrade", "Upgrade")
                        .WithMany("BoughtUpgrades")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Nami.Database.Models.Chicken", "Chicken")
                        .WithMany("Upgrades")
            ...
            modelBuilder.Entity("Nami.Database.Models.EmojiReactionTrigger", b =>
                {
                    b.HasOne("Nami.Database.Models.EmojiReaction", "Reaction")
                        .WithMany("DbTriggers")
            ...
            modelBuilder.Entity("Nami.Database.Models.PurchasedItem", b =>
                {
                    b.HasOne("Nami.Database.Models.PurchasableItem", "Item")
                        .WithMany("Purchases")
            ...
            modelBuilder.Entity("Nami.Database.Models.RssSubscription", b =>
                {
                    ...
                    b.HasOne("Nami.Database.Models.RssFeed", "Feed")
                        .WithMany("Subscriptions")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Nami.Database.Models.TextReactionTrigger", b =>
                {
                    b.HasOne("Nami.Database.Models.TextReaction", "Reaction")
                        .WithMany("DbTriggers")
                        .HasForeignKey("ReactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
