...
using Nami.Modules.Owner.Extensions;
...
namespace Nami.Modules.Owner
{
    ...
    [Aliases("admin", "o")]
    public sealed class OwnerModule : NamiModule
    {
        #region announce
        ...
        public Task UptimeAsync(CommandContext ctx)
        {
            ...
            return ctx.RespondWithLocalizedEmbedAsync(emb => {
                ...
                emb.WithDescription($"{Nami.ApplicationName} {Nami.ApplicationVersion}");
