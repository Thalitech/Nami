...
namespace Nami.Modules.Search
{
    ...
    public sealed class RssFeedsModule : NamiServiceModule<RssFeedsService>
    {
        #region rss
        [Command("rss")]
        [Aliases("feed")]
        ...
        public sealed class SubscribeModule : NamiServiceModule<RssFeedsService>
        {
            #region subscribe
        ...
        [Aliases("unsub")]
        [RequireGuild, RequireOwnerOrPermissions(Permissions.ManageGuild)]
        public sealed class UnsubscribeModule : NamiServiceModule<RssFeedsService>
        {
            #region unsubscribe
            [GroupCommand, Priority(1)]
            public async Task ExecuteGroupAsync(CommandContext ctx,
