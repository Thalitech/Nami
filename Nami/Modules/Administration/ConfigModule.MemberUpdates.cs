...
{
    public sealed partial class ConfigModule : NamiServiceModule<GuildConfigService>
    {
        #region config welcome
        [Group("welcome")]
        [Aliases("enter", "join", "wlc", "wm", "w")]
        public sealed class ConfigModuleWelcome : NamiServiceModule<GuildConfigService>
        {
            #region config welcome
        ...
        public class ConfigModuleLeave : NamiServiceModule<GuildConfigService>
        {
            #region config leave
            [GroupCommand, Priority(1)]
            public async Task ExecuteGroupAsync(CommandContext ctx,
