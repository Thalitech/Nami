...
namespace Nami.Modules.Administration
{
    ...
    public sealed class ForbiddenNamesModule : NamiServiceModule<ForbiddenNamesService>
    {
        ...
        public class ForbiddenNamesDeleteModule : NamiServiceModule<ForbiddenNamesService>
        {
            #region forbiddennames delete
            [GroupCommand, Priority(1)]
